...
namespace BluetoothPrint.droid
{
    ...
    class BluetoothService
    {
        ...
        private void SetState(int state)
        {
            ...
            _handler.ObtainMessage(BluetoothHelper.MESSAGE_STATE_CHANGE, state, -1).SendToTarget();
        }
        ...
        private void ConnectionFailed()
        {
            ...
            var msg = _handler.ObtainMessage(BluetoothHelper.MESSAGE_CONNCETFAILED);
            Bundle bundle = new Bundle();
            bundle.PutString(BluetoothHelper.TOAST, "Unable to connect device");
            msg.Data = bundle;
            _handler.SendMessage(msg);
        }
        ...
        public void ConnectionLost()
        {
            ...
            Bundle bundle = new Bundle();
            bundle.PutString(BluetoothHelper.TOAST, "Device connection was lost");
            msg.Data = bundle;
            _handler.SendMessage(msg);
        }
        ...
        private class ConnectedThread : Thread
        {
            ...
            public override void Run()
            {
                ...
                while (true)
                {
                    try
                    {
                        ...
                        _service._handler.ObtainMessage(BluetoothHelper.MESSAGE_READ, bytes, -1, buffer)
                            .SendToTarget();
                    }
                    catch (Java.IO.IOException e)
                    {
            ...
            public bool Write(byte[] buffer)
            {
                try
                {
                    ...
                    _service._handler.ObtainMessage(BluetoothHelper.MESSAGE_WRITE, -1, -1, buffer)
                        .SendToTarget();
                    return true;
                }
                catch (Java.IO.IOException e)
